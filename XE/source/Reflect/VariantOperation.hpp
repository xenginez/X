...
template<> struct VariantCreate< char * >
{
	...
	{
		return { XE::VariantWarpperData( XE::String( val ) ) };
	}
};
...
template< typename T > struct VariantCreate
{
	static  XE::VariantData Create( const T & val )
	{
		...
		{
			return { XE::VariantPointerData( val ) };
		}
...
{
	static bool Cast( const XE::VariantData & val )
	{
...
{
	static XE::int8 Cast( const XE::VariantData & val )
	{
...
{
	static XE::int16 Cast( const XE::VariantData & val )
	{
...
{
	static XE::int32 Cast( const XE::VariantData & val )
	{
...
{
	static XE::int64 Cast( const XE::VariantData & val )
	{
...
{
	static XE::uint8 Cast( const XE::VariantData & val )
	{
...
{
	static XE::uint16 Cast( const XE::VariantData & val )
	{
...
{
	static XE::uint32 Cast( const XE::VariantData & val )
	{
...
{
	static XE::uint64 Cast( const XE::VariantData & val )
	{
...
{
	static XE::float32 Cast( const XE::VariantData & val )
	{
...
{
	static XE::float64 Cast( const XE::VariantData & val )
	{
...
template<> struct VariantCast< XE::AnsiString >
{
	...
	{
		if( std::visit( XE::VariantDataIsCanConvert< XE::String >(), val ) )
		{
			return *reinterpret_cast <XE::String *>( std::visit( XE::VariantDataGetRawPointer(), const_cast<XE::VariantData &>( val ) ) );
		}
...
template<> struct VariantCast< bool & >
{
	static bool & Cast( const XE::VariantData & val )
	{
		return std::get< bool >( const_cast<XE::VariantData &>( val ) );
	}
};
...
template<> struct VariantCast< XE::int8 & >
{
	static XE::int8 & Cast( const XE::VariantData & val )
	{
		return std::get< XE::int8 >( const_cast<XE::VariantData &>( val ) );
	}
};
...
template<> struct VariantCast< XE::int16 & >
{
	static XE::int16 & Cast( const XE::VariantData & val )
	{
		return std::get< XE::int16 >( const_cast<XE::VariantData &>( val ) );
	}
};
...
template<> struct VariantCast< XE::int32 & >
{
	static XE::int32 & Cast( const XE::VariantData & val )
	{
		return std::get< XE::int32 >( const_cast<XE::VariantData &>( val ) );
	}
};
...
template<> struct VariantCast< XE::int64 & >
{
	static XE::int64 & Cast( const XE::VariantData & val )
	{
		return std::get< XE::int64 >( const_cast<XE::VariantData &>( val ) );
	}
};
...
template<> struct VariantCast< XE::uint8 & >
{
	static XE::uint8 & Cast( const XE::VariantData & val )
	{
		return std::get< XE::uint8 >( const_cast<XE::VariantData &>( val ) );
	}
};
...
template<> struct VariantCast< XE::uint16 & >
{
	static XE::uint16 & Cast( const XE::VariantData & val )
	{
		return std::get< XE::uint16 >( const_cast<XE::VariantData &>( val ) );
	}
};
...
template<> struct VariantCast< XE::uint32 & >
{
	static XE::uint32 & Cast( const XE::VariantData & val )
	{
		return std::get< XE::uint32 >( const_cast<XE::VariantData &>( val ) );
	}
};
...
template<> struct VariantCast< XE::uint64 & >
{
	static XE::uint64 & Cast( const XE::VariantData & val )
	{
		return std::get< XE::uint64 >( const_cast<XE::VariantData &>( val ) );
	}
};
...
template<> struct VariantCast< XE::float32 & >
{
	static XE::float32 & Cast( const XE::VariantData & val )
	{
		return std::get< XE::float32 >( const_cast<XE::VariantData &>( val ) );
	}
};
...
template<> struct VariantCast< XE::float64 & >
{
	static XE::float64 & Cast( const XE::VariantData & val )
	{
		return std::get< XE::float64 >( const_cast<XE::VariantData &>( val ) );
	}
};
...
template<> struct VariantCast< const char * >
{
	static char const * Cast( const XE::VariantData & val )
	{
		if( std::visit( XE::VariantDataIsCanConvert< XE::String >(), val ) )
		{
			return reinterpret_cast<XE::String *>( std::visit( XE::VariantDataGetRawPointer(), const_cast<XE::VariantData &>( val ) ) )->c_str();
		}
...
template< typename T > struct VariantCast
{
	static T Cast( const XE::VariantData & val )
	{
		...
		{
			return *( XE::VariantCast< T * >::Cast( val ) );
		}
...
template< typename T > struct VariantCast< T * >
{
	static T * Cast( const XE::VariantData & val )
	{
		if( std::visit( XE::VariantDataIsCanConvert< typename XE::TypeTraits< T >::raw_t >(), val ) )
		{
			return reinterpret_cast<T *>( std::visit( XE::VariantDataGetRawPointer(), const_cast<XE::VariantData &>( val ) ) );
		}
...
template< typename T > struct VariantCast< T & >
{
	static T & Cast( const XE::VariantData & val )
	{
		...
		else if( std::visit( XE::VariantDataIsCanConvert< T >(), val ) )
		{
			return *( XE::VariantCast< T * >::Cast( val ) );
		}
...
template< typename T > struct VariantCast< XE::SharedPtr< T > >
{
	...
	{
		if( std::visit( XE::VariantDataIsType< XE::VariantWarpperData >(), val ) && std::get< XE::VariantWarpperData >( val ).Pointer->IsSharedPtr() && std::visit( XE::VariantDataIsCanConvert< T >(), val ) )
		{
			return std::reinterpret_pointer_cast<T>( std::get< XE::VariantWarpperData >( val ).Pointer->SharedPointer() );
		}
