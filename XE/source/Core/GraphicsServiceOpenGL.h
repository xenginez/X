 ...
 *
 */
#ifndef GRAPHICSSERVICEOPENGL_H__12AD41F4_6AC0_43BC_946C_BB7DE4A3D47F
#define GRAPHICSSERVICEOPENGL_H__12AD41F4_6AC0_43BC_946C_BB7DE4A3D47F
...
class GraphicsServiceOpenGL
{
private:
	struct Private;

public:
	GraphicsServiceOpenGL( bool debug = false );

	~GraphicsServiceOpenGL();
...
public:
	XE::GraphicsBackendType GetBackendType() const { return XE::GraphicsBackendType::OPENGL; };
...
#endif//GRAPHICSSERVICEOPENGL_H__12AD41F4_6AC0_43BC_946C_BB7DE4A3D47F
