 ...
 *
 */
#ifndef GRAPHICSSERVICED3D12_H__F4A7957D_4BBA_45BA_8D40_261ED831F61E
#define GRAPHICSSERVICED3D12_H__F4A7957D_4BBA_45BA_8D40_261ED831F61E
...
class GraphicsServiceD3D12
{
private:
	struct Private;

public:
	GraphicsServiceD3D12( bool debug = false );

	~GraphicsServiceD3D12();
...
public:
	XE::GraphicsBackendType GetBackendType() const { return XE::GraphicsBackendType::D3D12; };
...
#endif//GRAPHICSSERVICED3D12_H__F4A7957D_4BBA_45BA_8D40_261ED831F61E
