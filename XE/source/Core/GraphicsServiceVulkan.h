 ...
 *
 */
#ifndef GRAPHICSSERVICEVULKAN_H__8ADDC261_6FC6_4644_918A_1879711BA225
#define GRAPHICSSERVICEVULKAN_H__8ADDC261_6FC6_4644_918A_1879711BA225
...
class GraphicsServiceVulkan
{
private:
	struct Private;

public:
	GraphicsServiceVulkan( bool debug = false );

	~GraphicsServiceVulkan();
...
public:
	XE::GraphicsBackendType GetBackendType() const { return XE::GraphicsBackendType::VULKAN; };
...
#endif//GRAPHICSSERVICEVULKAN_H__8ADDC261_6FC6_4644_918A_1879711BA225
